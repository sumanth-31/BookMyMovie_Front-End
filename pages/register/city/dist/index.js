...
var CityRegistration = function () {
    ...
    var registerCity = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var city, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    url = index_2.API_URLS.buildUrl("citiesUrl");
    ...
    return (react_1["default"].createElement("div", { className: "d-flex flex-column justify-content-center vh-100" },
        ...
        react_1["default"].createElement("div", { className: "d-flex flex-column align-items-center flex-grow-1 justify-content-center" },
            react_1["default"].createElement("form", { className: "w-50", onSubmit: registerCity },
                react_1["default"].createElement("div", { className: "form-group " },
                    react_1["default"].createElement("label", null, "City Name"),
                    react_1["default"].createElement("input", { className: "form-control", placeholder: "Enter City Name", required: true, onChange: function (e) {
                            setCityName(e.target.value);
                        } })),
                react_1["default"].createElement("button", { className: "btn btn-primary w-100" }, "Submit")))));
};
exports["default"] = CityRegistration;
